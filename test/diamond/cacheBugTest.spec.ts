...
describe('Cache bug test', async () => {
  ...
  before(async function () {
    ...
    let diamondCutFacet = await ethers.getContractAt('DiamondCutFacet', diamondAddress) as DiamondCutFacet
    diamondLoupeFacet = await ethers.getContractAt('DiamondLoupeFacet', diamondAddress) as DiamondLoupeFacet
    // const Test1Facet = await ethers.getContractFactory('Test1Facet')
    test1Facet = await new Test1Facet__factory(signer).deploy() // await Test1Facet.deploy()
