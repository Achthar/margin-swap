...
import { TestERC20Periphery, TestCallbackValidation } from '../../../types'
...
describe('CallbackValidation', () => {
  ...
  const callbackValidationFixture: Fixture<{
    ...
    tokens: [TestERC20Periphery, TestERC20Periphery]
    factory: Contract
    ...
    const tokens: [TestERC20Periphery, TestERC20Periphery] = [
  ...
  let tokens: [TestERC20Periphery, TestERC20Periphery]
