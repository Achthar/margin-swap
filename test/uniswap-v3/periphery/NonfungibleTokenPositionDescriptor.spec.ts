...
import { NonfungibleTokenPositionDescriptor, MockTimeNonfungiblePositionManager, TestERC20Periphery } from '../../../types'
...
describe('NonfungibleTokenPositionDescriptor', () => {
  ...
  beforeEach('load fixture', async () => {
    ...
    const tokenFactory = await ethers.getContractFactory('TestERC20Periphery')
    weth9 = tokenFactory.attach(await nftPositionDescriptor.WETH9()) as TestERC20Periphery
  })
