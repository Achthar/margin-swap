...
} from '../../../artifacts/contracts/external-protocols/uniswapV3/core/interfaces/IUniswapV3Pool.sol/IUniswapV3Pool.json'
import { Fixture } from 'ethereum-waffle'
import { BigNumber, constants, ContractTransaction, Wallet } from 'ethers'
import { ethers, waffle } from 'hardhat'
import { IUniswapV3Pool, IWETH9, MockTimeSwapRouter, TestERC20Periphery } from '../../../types'
...
describe('SwapRouter gas tests', function () {
  ...
  let tokens: [TestERC20Periphery, TestERC20Periphery, TestERC20Periphery]
  ...
  describe('#exactInput', () => {
    ...
    it('0 -> 1 minimal', async () => {
      const calleeFactory = await ethers.getContractFactory('TestUniswapV3CalleePeriphery')
